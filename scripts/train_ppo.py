...
Data comes exclusively from ``splits.json`` (``scripts/make_splits.py``):

  * training pool: ``rg30_train`` (1620 RG30 instances)
  * in-training validation: ``rg30_validation`` (180 RG30 instances, stratified)
